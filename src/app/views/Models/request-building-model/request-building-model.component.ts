...
loadingZones: Set<string> = new Set();
  ...
  ngOnInit(): void {
   ...
   //  // JH Ground Floor
    ...
    else if (this.data.floor.name == 'Zone 0.A2' && this.data.floor.planType == 'JH - Ground Floor') {
      this.floorBlock = [
        {
          value: '0073AT001',
          className: "JH_0_A2-1",
    ...
    else if (this.data.floor.name == 'Zone 0.B2' && this.data.floor.planType == 'JH - Ground Floor') {
      this.floorBlock = [
        {
          value: 'PAU-0082Z-01',
          className: "JH_0_B2-1",
   ...
   //  // JH 1st Floor
    ...
    else if (this.data.floor.name == 'Zone 1.A1' && this.data.floor.planType == 'JH - 1st Floor') {
      this.floorBlock = [
        {
          value: '1.002',
          className: "JH_1_A1-1",
    ...
    else if (this.data.floor.name == 'Zone 1.A2' && this.data.floor.planType == 'JH - 1st Floor') {
      this.floorBlock = [
        {
          value: '0073AT001',
          className: "JH_1_A2-1",
    ...
    else if (this.data.floor.name == 'Zone 1.B1' && this.data.floor.planType == 'JH - 1st Floor') {
      this.floorBlock = [
        {
          value: 'TR01',
          className: "JH_1_B1-1",
    ...
    else if (this.data.floor.name == 'Zone 1.B2' && this.data.floor.planType == 'JH - 1st Floor') {
      this.floorBlock = [
        {
          value: '0082AT001',
          className: "JH_1_B2-1",
    ...
    else if (this.data.floor.name == 'Zone 1.B3' && this.data.floor.planType == 'JH - 1st Floor') {
      this.floorBlock = [
        {
          value: '1.003.2',
          className: "JH_1_B3-1",
   ...
   // JH Mezzanine Floor
    ...
    else if (this.data.floor.name == 'Zone M.A1' && this.data.floor.planType == 'JH - Mezzanine Floor') {
      this.floorBlock = [
        {
          value: 'S.104-A',
          className: "JH_M_A1-1",
    ...
    else if (this.data.floor.name == 'Zone M.A2' && this.data.floor.planType == 'JH - Mezzanine Floor') {
      this.floorBlock = [
        {
          value: 'S.102',
          className: "JH_M_A2-1",
    ...
    else if (this.data.floor.name == 'Zone R_East' && this.data.floor.planType == 'JH - Roof Plan') {
      this.floorBlock = [
        {
          value: 'TR02',
    ...
    else if (this.data.floor.name == 'Zone 0.A1' && this.data.floor.planType == 'JJ - Ground Floor') {
      this.floorBlock = [
        {
          value: 'S.001',
          className: "JJ_0_A1-1",
    ...
    else if (this.data.floor.name == 'Zone 0.A2' && this.data.floor.planType == 'JJ - Ground Floor') {
      this.floorBlock = [
        {
          value: 'JJ000702FC001',
          className: "JJ_0_A2-1",
    ...
    else if (this.data.floor.name == 'Zone 0.A3' && this.data.floor.planType == 'JJ - Ground Floor') {
      this.floorBlock = [
        {
          value: 'TR01',
          className: "JJ_0_A3-1",
    ...
    else if (this.data.floor.name == 'Zone 0.B1' && this.data.floor.planType == 'JJ - Ground Floor') {
      this.floorBlock = [
        {
          value: '0132FSE001',
          className: "JJ_0_B1-1",
    ...
    else if (this.data.floor.name == 'Zone 0.B2' && this.data.floor.planType == 'JJ - Ground Floor') {
      this.floorBlock = [
        {
          value: 'JJ000701FC203',
          className: "JJ_0_B2-1",
    ...
    else if (this.data.floor.name == 'Zone 1.A1' && this.data.floor.planType == 'JJ - 1st Floor') {
      this.floorBlock = [
        {
          value: 'Tavle A',
          className: "JJ_1_A1-1",
    ...
    else if (this.data.floor.name == 'Zone 1.A2' && this.data.floor.planType == 'JJ - 1st Floor') {
      this.floorBlock = [
        {
          value: '1.002',
          className: "JJ_1_A2-1",
    ...
    else if (this.data.floor.name == 'Zone 1.A3' && this.data.floor.planType == 'JJ - 1st Floor') {
      this.floorBlock = [
        {
          value: 'Tavle BF',
          className: "JJ_1_A3-1",
    ...
    else if (this.data.floor.name == 'ZoneR_North' && this.data.floor.planType == 'JJ - Roof Plan') {
      this.floorBlock = [
        {
          value: 'Roof North',
    ...
    else if (this.data.floor.name == 'ZoneR_South' && this.data.floor.planType == 'JJ - Roof Plan') {
      this.floorBlock = [
        {
          value: '0132FW001',
